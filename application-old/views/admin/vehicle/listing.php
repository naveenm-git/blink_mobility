			...
			<div class="col-xs-12">
				<div class="box-content bordered default">
                  ...
                  <div class="dropdown js__drop_down">
                     ...
                     <a class="btn btn-xs btn-black btn-rounded btn-bordered" href="<?php echo base_url('admin/vehicle-add'); ?>" title="Add new author detail"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add New Vehicle</a>
                  </div>
               </h4>
    ...
    <script>
         $(document).ready(function(){
            ...
            var dataTable = $('#datatable').DataTable({
               ...
               "order": [[ 2, "desc" ]],
               "columnDefs": [
                  { "orderable": false, "targets": [0, 1, 3, 4, 5, -1] }
               ],
               "processing": true,
               "serverSide": true,
               "ajax":{
