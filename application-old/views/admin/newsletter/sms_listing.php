			...
			<div class="col-xs-12">
				<div class="box-content bordered default">
					<h4 class="box-title"><?php echo $heading; ?>
						<a class="btn btn-xs btn-black btn-rounded btn-bordered pull-right" style="margin-left:5px;" href="<?php echo base_url('admin/sms-template-add'); ?>" title="Add new author detail"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add New SMS Template</a>
