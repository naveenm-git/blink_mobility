    ...
    <div class="row small-spacing">
      <div class="col-md-12 col-xs-12">
				<div class="box-content bordered default">
					...
					<?php $attributes = array('class' => 'form-horizontal form-swal-submit', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator'); echo form_open('admin/model/save',$attributes); ?>
						<input type="hidden" name="objectid" value="<?php echo ($form_mode)?(string)$result['_id']:''; ?>">
							
                  <div class="form-group">
                     <label class="col-sm-3 control-label" for="make_id">Make <span class="req">*</span></label>
                     <div class="col-sm-9">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="model">Model <span class="req">*</span></label>
							<div class="col-sm-9">
								<input name="model" id="model" type="text" class="form-control" value="<?php echo (count($result)>0)?$result['model']:''; ?>" required/>
								<div class="help-block with-errors"></div>
							</div>
						</div>
