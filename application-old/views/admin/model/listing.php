			...
			<div class="col-xs-12">
				<div class="box-content bordered default">
                  ...
                  <div class="dropdown js__drop_down">
                     ...
                     <a class="btn btn-xs btn-black btn-rounded btn-bordered" href="<?php echo base_url('admin/model-add'); ?>" title="Add new author detail"><i class="fa fa-plus">&nbsp;&nbsp;</i>Add New Model</a>
                  </div>
               </h4>
