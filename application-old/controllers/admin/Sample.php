...
class Sample extends MY_Controller {
	...
	public function updatedetail(){
		// $this->admin_model->update_details(EVENTS, ['last_date'=>1585655999], ['_id'=>objectid('5e84981155af3f78034646d2')]);
	}
	
	public function trash(){
		// $this->admin_model->commonDelete(VEHICLE, []);
		// $this->admin_model->commonDelete(MAKE, []);
		// $this->admin_model->commonDelete(MODEL, []);
