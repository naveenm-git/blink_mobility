...
class MY_Session extends CI_Session {
	...
	function sess_write()
	{
		...
		$this->CI->mongo_db->set(array('last_activity' => $this->userdata['last_activity'], 'user_data' => $custom_userdata));
		$this->CI->mongo_db->update($this->sess_collection_name);
	...
	function sess_update()
	{
		...
		if ($this->sess_use_mongo === TRUE)
		{
			...
			$this->CI->mongo_db->where(array("session_id"=>$old_sessid));
			$this->CI->mongo_db->set(array('last_activity' => $this->now, 'session_id' => $new_sessid));
			$this->CI->mongo_db->update($this->sess_collection_name);
		}
